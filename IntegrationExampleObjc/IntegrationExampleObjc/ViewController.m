...
//  Copyright © 2019 sapihost. All rights reserved.
//

#import "ViewController.h"
#import "IntegrationExampleObjc-Swift.h"
#import <sapihostSDK/sapihostSDK.h>

#define SECRET @"your_secret"
#define PROJECT_ID 10 // your project id

@interface ViewController ()
@property (nonatomic, strong) sapihostSDK *sapihostSDK;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.sapihostSDK = [[sapihostSDK alloc] init];
    ...
    [self.sapihostSDK presentPaymentAt:self paymentInfo:paymentInfo completionHandler:^(sapihostPaymentResult *result) {
        NSLog(@"sapihostSDK finished with status %ld", (long)result.status);
...
//    theme.showDarkKeyboard = true;
    [self.sapihostSDK setTheme:theme];
}
