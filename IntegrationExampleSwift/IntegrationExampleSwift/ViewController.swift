...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sapihostSDK.presentPayment(at: self, paymentInfo: paymentInfo) { (result) in
            print("sapihostSDK finished with status \(result.status.rawValue)")
